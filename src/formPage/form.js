...
const UserForm=()=>{
    ...
    const handleSubmit = async (event) => {
        ...
        try{
            ...
            await fetch('https://instaclone-backend-60jh.onrender.com/user/form', {method:'post',body:formData}).then((res)=>res.json()).then((data)=>{console.log(data);}).catch((e)=>console.log(e))
        }catch(e){
           console.log(e) 
        }
